  ...
  return (
    <header className="mtt-nav">
      <div className="mtt-nav__inner">
        ...
        <Link href="/create" className="mtt-nav__cta">Create their book</Link>
      ...
      {isOpen && (
        <nav className="mtt-nav__mobile" aria-label="Mobile navigation">
          ...
          <Link href="/create" onClick={() => setIsOpen(false)}>Create their book <span aria-hidden="true">→</span></Link>
        </nav>
      )}
    </header>
  );
