  ...
  return (
    <button
      ...
      style={{
        ...
        background: checked ? "#A94F38" : "rgba(31,42,40,0.16)",
...
export default function CookieBanner() {
  ...
  return (
    <>
      ...
      {showModal && (
        <div style={{ position: "fixed", inset: 0, zIndex: 10000, background: "rgba(31,42,40,0.48)", backdropFilter: "blur(4px)", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }} onClick={e => { if (e.target === e.currentTarget) setShowModal(false); }}>
          <div style={{ background: "#FBF6EC", border: "1px solid rgba(31,42,40,0.18)", borderRadius: 4, padding: "clamp(24px, 5vw, 36px)", maxWidth: 480, width: "100%", boxShadow: "0 24px 64px rgba(50,38,19,0.28)" }}>
            <h3 style={{ color: "#1F2A28", fontFamily: "var(--font-fraunces, Georgia, serif)", fontSize: 22, fontWeight: 600, margin: "0 0 8px" }}>Cookie Preferences</h3>
