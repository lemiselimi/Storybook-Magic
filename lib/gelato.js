...
// Interior PDF is padded to 28 pages by generate-book-pdf (this product's
// minimum; Gelato rejects anything lower as "Page count is invalid"). The
// actual count is stored on result.interiorPageCount and used when present.
const INTERIOR_PAGE_COUNT = 28;
