    ...
    <div className="mtt-home">
      ...
      <main>
        <section className="mtt-hero" aria-labelledby="hero-title">
          <div className="mtt-hero__copy">
            ...
            <div className="mtt-actions">
              <Link href="/create" className="mtt-button mtt-button--ink">Read their first pages <span aria-hidden="true">→</span></Link>
              <a href="#inside-the-book" className="mtt-text-link">Open the book <span aria-hidden="true">↓</span></a>
            </div>
            <p className="mtt-hero__note">Their character, name, and first {P.freePreviewPages} story pages—before you decide. No card required. <Link href="/childrens-data">Photos are deleted within {P.photoDeletionHours} hours.</Link></p>
          </div>
        ...
        <section className="mtt-transformation" id="how-it-works" aria-labelledby="transformation-title">
          ...
          <Link href="/create" className="mtt-text-link mtt-text-link--strong">Read the beginning of their story <span aria-hidden="true">→</span></Link>
        </section>
        ...
        <section className="mtt-quiet-cta" aria-labelledby="cta-title">
          ...
          <Link href="/create" className="mtt-button mtt-button--ink">Read their first pages <span aria-hidden="true">→</span></Link>
          <p>Two personalised pages. No card required.</p>
        </section>
      </main>
