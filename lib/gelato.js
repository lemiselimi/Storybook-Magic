...
// Interior PDF is padded to this many pages by generate-book-pdf (this
// product's minimum; Gelato rejects anything lower as "Page count is invalid").
// The actual count is stored on result.interiorPageCount and used when present.
// Overridable via env so the minimum can be tuned without a code change.
const INTERIOR_PAGE_COUNT = Number(process.env.GELATO_INTERIOR_PAGES) || 31;
